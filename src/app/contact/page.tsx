            ...
            <div className="rounded-2xl border border-white/20 bg-white/5 p-6 sm:p-8">
                ...
                <div className="mt-3 space-y-2">
                  {CONTACT.whatsapp.map((w) => (
                    <a
                      ...
                      className="flex items-center gap-3 rounded-xl border border-white/15 bg-white/[0.03] px-4 py-3 text-sm text-white/90 transition hover:border-white/40 hover:bg-white/[0.06]"
                    >
                      <WhatsAppIcon />
              ...
              <div className="mt-6">
                ...
                <a
                  ...
                  className="mt-3 flex items-center gap-3 rounded-xl border border-white/15 bg-white/[0.03] px-4 py-3 text-sm text-white/90 transition hover:border-white/40 hover:bg-white/[0.06]"
                >
                  <MailIcon />
