...
// Payout / account setup, the "Payment" tab of the owner Profile page (it lived
// on its own "Course payments" sidebar page before that entry was folded into
// the Profile page). Self-contained: owns its load/save, links (or disconnects)
// the institute's Paystack subaccount so course fees settle to the academy's own
// bank, and manages the admission-agent commission rate.
