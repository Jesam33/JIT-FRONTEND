      ...
      <header className="sticky top-0 z-40 bg-black/55 [html.light_&]:bg-site-bg/75 backdrop-blur-md">
        <div className="container-wide flex items-center justify-between gap-6 py-6">
          <Link href="/" onMouseDown={onNavigate} className="inline-flex items-center" aria-label="Jorsas home">
            <img src="/images/jorsas-logo-white.png" alt="Jorsas" className="h-9 w-auto [html.light_&]:hidden" />
            <img src="/images/jorsas-logo-light-mode.png" alt="Jorsas" className="hidden h-9 w-auto [html.light_&]:block" />
          </Link>
